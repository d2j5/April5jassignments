...
console.log(`original numbers array: ${numbers}, squares array: ${squares}, evenSquares array: ${evenSquares}, extracted even squares: ${firstEvenSquare}, ${secondEvenSquare}`);
